...
const App: React.FC = () => {
 ...
 // Unconditional callbacks — no hooks inside
 ...
 setReservations(data || []); // Always array
 } catch (error) {
 ...
 // SAFE, UNCONDITIONAL useMemos — always run, stable deps
 ...
 }, [searchQuery, reservations]); // Stable deps
 ...
 if (!searchQuery.trim()) return dailyReservations;
 ...
 }, [reservations, selectedDate, searchQuery]); // Stable deps

 if (appStatus === 'testing' || isLoading) {
